...
<body class="layui-layout-body">
  ...
  <div class="layui-body">
    ...
    <div class="layui-container" style="padding: 15px;">
    	<blockquote class="layui-elem-quote"><h3><a href="/admin/manage_album.php?nav=2-4">相册管理</a>&nbsp;&nbsp;/&nbsp;&nbsp;相册信息修改</h3></blockquote> 
    	<form class="layui-form" style="margin: 20px;">
		  ...
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text" name="album_name" value="<?php echo $album_name;?>" required lay-verify="required" placeholder="请输入相册名" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  <div class="layui-form-item">
		    <label class="layui-form-label">相册简介</label>
		    <div class="layui-input-block">
		        <textarea name="album_intro" required lay-verify="required|introduction" placeholder="请输入相册简介" class="layui-textarea"><?php echo $album_intro;?></textarea>
		    </div> 
		  </div>
		  <div class="layui-form-item">
		    		...
		    		<?php
			    		...
			    		if($tag_info){
							...
							foreach ($tag_info as $key => $value) {
								...
								echo "<span check='".$check."' data-id={$value['id']} class='layui-btn layui-bg-{$value['tag_color']}  tag-btn ".$gray."'>{$value['tag_name']}</span>";
			    			}
			    		}
				      ?>
		    	</span>
		  ...
		  <div class="layui-form-item">
		    <div class="layui-input-block">
		      <button class="layui-btn" type="submit" lay-submit lay-filter="album_submit">保存</button>
		    </div>
		  </div>
		</form>
    </div>
